...
public class EmployeeConnection {
	...
	public EmployeeConnection() throws ClassNotFoundException {
	try{
	String url="jdbc:oracle:thin:@localhost:1521:xe";
	String user="System";
	String password="abishek2004";
	...
	public void createEmployee(EmployeeDataBase employee) {
	try {
	...
	public EmployeeDataBase readEmployee(int eid) {
	try {
	select.setInt(1,eid);
	...
	return new EmployeeDataBase(eid,ename,degree,salary);
	}
	}
	catch(SQLException e) {
	System.out.println("SQL Exception....");
	...
	public void updateEmployee(EmployeeDataBase employee) {
	try {
