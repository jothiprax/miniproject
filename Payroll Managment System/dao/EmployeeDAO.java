...
public class EmployeeDAO implements EmployeeDAOInterface {
    ...
    public void payRoll()
    {
        ...
        Statement stmt1 = connection.createStatement();
        Statement stmt2 = connection.createStatement();
        stmt1.executeUpdate("update employee set salary = salary+(salary*0.1)");
        stmt2.executeUpdate("update employee set salary = salary+(salary*0.1)");
        stmt1.executeQuery("select * from employeeofficialdetails");
        stmt2.executeQuery("select * from employeepersonaldetails");
        ...
        System.out.println("\nDisplaying the PayRoll details of a employees\n");
...
public void getJobLevel(double salary)
{
    try{
         Scanner sc = new Scanner(System.in);
        connection = DBConnection.createDBConnection();
        ...
        PreparedStatement statement= connection.prepareStatement("select salary from employeeofficialdetails WHERE id=?")
        ...
        if(rs1.next()){
            ...
            int jobLevel=getJobLevel(salary);
