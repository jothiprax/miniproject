...
class Movieticketbooking {
	...
	String insertQuery = "INSERT INTO RailwayTicketDetail(ticket_id,name,
	source, destination,class,age,gender,ph_number,fare) VALUES
	(?,?,?,?,?,?,?,?,?)";
	...
	ystem.out.println("Ticket booked successfully!");
	break;
	case 2:
	// Update ticket fare
	...
	String updateQuery = "UPDATE RailwayTicketDetail SET fare= ? WHERE
	ticket_id = ?";
	...
	String updateQuery1 = "UPDATE RailwayTicketDetail SET class = ? WHERE
	ticket_id = ?";
	...
	String updateQuery2 = "UPDATE RailwayTicketDetail SET destination= ?
	WHERE ticket_id = ?";
	...
	String updateQuery3= "UPDATE RailwayTicketDetail SET age= ? WHERE
	ticket_id = ?";
	...
	String updateQuery4 = "UPDATE RailwayTicketDetail SET ph_number= ?
	WHERE ticket_id = ?";
	...
	lse
	{S
	ystem.out.print(" ----- TICKET DETAILS ----- ");
	System.out.println();
	System.out.print("\n-------------------------------------------------
	---------------------------------------------------------------------
	----------------------------------------------------\n");
	...
	20s%s", "Ticket_ID",
	"Name","Source","Destination","Class","age","gender","ph_number","Far
	e");
	...
	{S
	tring output1 = String.format(" %-15s%-20s%-20s%-20s%-20s%-20s%-
	20s%-
	20s%s",resultSet.getString(1) ,resultSet.getString(2),resultSet.getSt
	ring(3),resultSet.getString(4),resultSet.getString(5),resultSet.getSt
	ring(6),resultSet.getString(7),resultSet.getString(8),resultSet.getSt
	ring(9));
